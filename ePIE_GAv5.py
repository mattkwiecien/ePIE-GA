...
for i in range(N_SETS):
    ...
    pixel=((6.62607e-34)*(3.0e8)*.45) / ((4.0615e-16)*150e-6*N)
    ps = stepsize / pixel 
    ###
    Z_VAL = .45
    ...
    def dims(xn, yn, stepsize, individual, list_filename, list_file_loc):
        ...
        #takes #of pixels, multilpies them by size of pixels
    ...
    #individual and population construction
